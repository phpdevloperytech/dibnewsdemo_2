            ...
            this.collection.each(function (i, el) {
                ...
                if (gMapType == 'satellite') {
                    ...
                    for (var i = 0; i < arrL; i++) {
                        var featureType = gMapStyles[i][0], elementType = gMapStyles[i][1], stylers = gMapStyles[i][2], obj = $.extend({}, gMapStylesArray[i]);
                        if (featureType != "") {
                ...
                if (gMapMultipleMarkers == true) {
                    var infowindow = new google.maps.InfoWindow(), marker, i2;
