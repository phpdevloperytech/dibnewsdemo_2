...
(function ($) {
            ...
            $w.on('resize.HSNavigation', function (e) {
                ...
                _self.resizeTimeoutId = setTimeout(function () {
                    _self._pageCollection.each(function (i, el) {
                        var $this = $(el), HSNavigation = $this.data('HSNavigation');
    ...
    HSNavigationOverlay.prototype.init = function () {
        ...
        if (this.toggler && this.toggler.length)
            this.toggler.css('display', 'block');
    ...
    HSNavigationOverlay.prototype.close = function () {
        var $this = this, hamburgers = $this.toggler && $this.toggler.length ? $this.toggler.find('.is-active') : $();
