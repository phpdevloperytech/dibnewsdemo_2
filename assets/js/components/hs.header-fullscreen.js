    ...
    $.HSCore.components.HSHeaderFullscreen = {
        ...
        init: function (collection, config) {
            ...
            return collection.each(function (i, el) {
                ...
                if ($this.data('HSHeaderFullscreen'))
                    return;
                $this.data('HSHeaderFullscreen', new HSHeaderFullscreen($this, itemConfig, new HSHeaderFullscreenOverlayEffect()));
        ...
        _bindGlobalEvents: function () {
            ...
            $(window).on('resize.HSHeaderFullscreen', function () {
                if (_self.resizeTimeOutId)
                    clearTimeout(_self.resizeTimeOutId);
                _self.resizeTimeOutId = setTimeout(function () {
                    _self._pageCollection.each(function (i, el) {
                        var $this = $(el), HSHeaderFullscreen = $this.data('HSHeaderFullscreen');
                        if (!HSHeaderFullscreen)
                            return;
